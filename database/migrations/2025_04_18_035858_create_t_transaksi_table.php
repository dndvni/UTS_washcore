...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('t_transaksi', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('pengambilan_id'); // relasi dari t_tipe_pengambilan
            ...
            $table->foreign('pengambilan_id')->references('pengambilan_id')->on('t_tipe_pengambilan')->onDelete('cascade');
        });
    }
